...
################################################################################
## Form generated from reading UI file 'dcs2GGZkkO.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.e_repeat = QLineEdit(Dialog)
        self.e_repeat.setObjectName(u"e_repeat")
        self.e_repeat.setGeometry(QRect(220, 306, 41, 23))
        self.e_repeat.setAlignment(Qt.AlignCenter)
        self.label_cur_num = QLabel(Dialog)
        self.label_cur_num.setObjectName(u"label_cur_num")
        self.label_cur_num.setGeometry(QRect(410, 416, 141, 21))
        ...
        self.groupBox_4.setGeometry(QRect(150, 136, 291, 151))
        ...
        font1.setBold(True)
        self.btn_set_param.setFont(font1)
        ...
        self.label_2.setGeometry(QRect(600, 16, 151, 41))
        font2 = QFont()
        ...
        self.label_IAM.setGeometry(QRect(972, 18, 121, 41))
        font3 = QFont()
        font3.setPointSize(30)
        font3.setBold(True)
        self.label_IAM.setFont(font3)
        self.label_IAM.setLayoutDirection(Qt.LeftToRight)
        self.label_IAM.setAlignment(Qt.AlignCenter)
        self.btn_connect_icsq = QPushButton(Dialog)
        self.btn_connect_icsq.setObjectName(u"btn_connect_icsq")
        self.btn_connect_icsq.setGeometry(QRect(760, 23, 71, 31))
        self.label_16 = QLabel(Dialog)
        self.label_16.setObjectName(u"label_16")
        self.label_16.setGeometry(QRect(150, 306, 61, 21))
        ...
        self.btn_acquireramp.setGeometry(QRect(270, 296, 101, 41))
        self.btn_acquireramp.setFont(font1)
        self.groupBox_3 = QGroupBox(Dialog)
        self.groupBox_3.setObjectName(u"groupBox_3")
        self.groupBox_3.setGeometry(QRect(10, 136, 131, 201))
        font4 = QFont()
        font4.setBold(False)
        ...
        self.btn_initialize1.setGeometry(QRect(10, 70, 71, 41))
        self.btn_initialize1.setFont(font1)
        ...
        self.cmb_ouput_channels.setGeometry(QRect(500, 37, 51, 23))
        ...
        self.btn_download_MCD.setGeometry(QRect(200, 70, 101, 41))
        self.btn_download_MCD.setFont(font1)
        self.label_4 = QLabel(self.groupBox)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(370, 37, 121, 21))
        self.label_4.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        self.label = QLabel(self.groupBox)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(10, 37, 41, 21))
        self.label.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        self.label_3 = QLabel(self.groupBox)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(150, 37, 151, 21))
        ...
        self.btn_initialize2.setGeometry(QRect(80, 70, 71, 41))
        self.btn_initialize2.setFont(font1)
        self.btn_set_detector = QPushButton(self.groupBox)
        self.btn_set_detector.setObjectName(u"btn_set_detector")
        self.btn_set_detector.setGeometry(QRect(300, 70, 81, 41))
        self.btn_set_detector.setFont(font1)
        self.btn_get_telemetry = QPushButton(self.groupBox)
        self.btn_get_telemetry.setObjectName(u"btn_get_telemetry")
        self.btn_get_telemetry.setGeometry(QRect(470, 70, 81, 41))
        font6 = QFont()
        font6.setPointSize(8)
        font6.setBold(True)
        self.btn_get_telemetry.setFont(font6)
        self.btn_connect_guiq = QPushButton(Dialog)
        self.btn_connect_guiq.setObjectName(u"btn_connect_guiq")
        self.btn_connect_guiq.setGeometry(QRect(830, 23, 71, 31))
        self.groupBox_6 = QGroupBox(Dialog)
        self.groupBox_6.setObjectName(u"groupBox_6")
        self.groupBox_6.setGeometry(QRect(10, 346, 561, 141))
        ...
        self.groupBox_2.setGeometry(QRect(600, 52, 481, 141))
        ...
        self.btn_connect_coreq = QPushButton(Dialog)
        self.btn_connect_coreq.setObjectName(u"btn_connect_coreq")
        self.btn_connect_coreq.setGeometry(QRect(900, 23, 71, 31))
        self.groupBox_7 = QGroupBox(Dialog)
        self.groupBox_7.setObjectName(u"groupBox_7")
        self.groupBox_7.setGeometry(QRect(600, 396, 481, 91))
        self.chk_autosave = QCheckBox(self.groupBox_7)
        self.chk_autosave.setObjectName(u"chk_autosave")
        self.chk_autosave.setGeometry(QRect(10, 27, 71, 31))
        self.label_28 = QLabel(self.groupBox_7)
        self.label_28.setObjectName(u"label_28")
        self.label_28.setGeometry(QRect(88, 32, 71, 21))
        ...
        self.label_29.setGeometry(QRect(78, 56, 81, 21))
        ...
        self.line.setGeometry(QRect(577, 26, 21, 461))
        self.line.setFrameShape(QFrame.VLine)
        self.line.setFrameShadow(QFrame.Sunken)
        self.btn_stop = QPushButton(Dialog)
        self.btn_stop.setObjectName(u"btn_stop")
        self.btn_stop.setGeometry(QRect(380, 296, 51, 41))
        self.btn_stop.setFont(font1)
        self.groupBox_9 = QGroupBox(Dialog)
        self.groupBox_9.setObjectName(u"groupBox_9")
        self.groupBox_9.setGeometry(QRect(600, 200, 481, 191))
        ...
        self.btn_write_Vreset.setFont(font1)
        ...
        self.btn_read_Vreset.setFont(font1)
        ...
        self.btn_read_Dsub.setFont(font1)
        ...
        self.btn_write_Dsub.setFont(font1)
        ...
        self.btn_read_Vbiasgate.setFont(font1)
        ...
        self.btn_write_Vbiasgate.setFont(font1)
        ...
        self.btn_read_Vrefmain.setFont(font1)
        ...
        self.btn_write_Vrefmain.setFont(font1)
        ...
        self.btn_write_input.setFont(font1)
        ...
        self.btn_read_input.setFont(font1)
        ...
        self.btn_ASIC_load.setFont(font1)
...
"Parameters", None))
        ...
        self.btn_connect_icsq.setText(QCoreApplication.translate("Dialog", u"ICS Q", None))
        ...
        self.btn_error_cnt.setText(QCoreApplication.translate("Dialog", u"Error Count", None))
        ...
        self.btn_connect_guiq.setText(QCoreApplication.translate("Dialog", u"GUI Q", None))
        ...
        self.btn_connect_coreq.setText(QCoreApplication.translate("Dialog", u"CORE Q", None))
